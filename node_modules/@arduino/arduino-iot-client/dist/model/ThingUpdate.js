 ...
 * @version 2.0.0
 */
var ThingUpdate = /*#__PURE__*/function () {
  /**
  ...
  function ThingUpdate() {
    _classCallCheck(this, ThingUpdate);
  ...
  _createClass(ThingUpdate, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['properties']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['properties']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _Property["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ThingUpdate;