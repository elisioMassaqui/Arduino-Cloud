...
var _ArduinoSeriesRawLastValueResponse = _interopRequireDefault(require("./ArduinoSeriesRawLastValueResponse"));
 ...
 * @version 2.0.0
 */
var ArduinoSeriesRawBatchLastvalue = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoSeriesRawBatchLastvalue(responses, status) {
    _classCallCheck(this, ArduinoSeriesRawBatchLastvalue);
   ...
   */
  _createClass(ArduinoSeriesRawBatchLastvalue, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoSeriesRawBatchLastvalue.RequiredProperties),
        _step;
      try {
      ...
      if (data['responses']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ArduinoSeriesRawLastValueResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoSeriesRawBatchLastvalue;