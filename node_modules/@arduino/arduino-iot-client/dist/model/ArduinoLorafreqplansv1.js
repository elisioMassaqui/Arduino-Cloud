...
var _ArduinoLorafreqplanv = _interopRequireDefault(require("./ArduinoLorafreqplanv1"));
 ...
 * @version 2.0.0
 */
var ArduinoLorafreqplansv1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoLorafreqplansv1() {
    _classCallCheck(this, ArduinoLorafreqplansv1);
   ...
   */
  _createClass(ArduinoLorafreqplansv1, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['frequency_plans']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['frequency_plans']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ArduinoLorafreqplanv["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoLorafreqplansv1;