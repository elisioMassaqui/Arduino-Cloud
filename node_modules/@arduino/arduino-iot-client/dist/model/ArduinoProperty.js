 ...
 * @version 2.0.0
 */
var ArduinoProperty = /*#__PURE__*/function () {
  /**
  ...
  _createClass(ArduinoProperty, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('linked_to_trigger')) {
          obj['linked_to_trigger'] = _ApiClient["default"].convertToType(data['linked_to_trigger'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoProperty.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ArduinoProperty;