...
var _BatchQueryRawRequestMediaV = _interopRequireDefault(require("./BatchQueryRawRequestMediaV1"));
 ...
 * @version 2.0.0
 */
var BatchQueryRawRequestsMediaV1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function BatchQueryRawRequestsMediaV1(requests, respVersion) {
    _classCallCheck(this, BatchQueryRawRequestsMediaV1);
   ...
   */
  _createClass(BatchQueryRawRequestsMediaV1, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BatchQueryRawRequestsMediaV1.RequiredProperties),
        _step;
      try {
      ...
      if (data['requests']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _BatchQueryRawRequestMediaV["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = BatchQueryRawRequestsMediaV1;