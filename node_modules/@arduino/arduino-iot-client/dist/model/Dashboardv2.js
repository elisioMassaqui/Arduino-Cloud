 ...
 * @version 2.0.0
 */
var Dashboardv2 = /*#__PURE__*/function () {
  /**
  ...
  _createClass(Dashboardv2, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['widgets']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['widgets']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _Widget["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = Dashboardv2;