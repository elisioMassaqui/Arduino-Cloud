 ...
 * @version 2.0.0
 */
var ArduinoDevicev2properties = /*#__PURE__*/function () {
  /**
  ...
  _createClass(ArduinoDevicev2properties, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoDevicev2properties.RequiredProperties),
        _step;
      try {
      ...
      if (data['properties']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ArduinoProperty["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoDevicev2properties;